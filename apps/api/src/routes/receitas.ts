...
receitasRouter.post("/", authenticate, requireRole("admin", "lider"), async (req, res, next) => {
  try {
...
receitasRouter.delete("/:id", authenticate, requireRole("admin", "lider"), async (req, res, next) => {
  try {
