...
import { AlertCircleIcon, ChevronLeftIcon, XIcon, CheckIcon, PlusIcon } from "lucide-react";
import {
  createContext,
  useCallback,
  useContext,
                        ...
                        if (hasSubMenu) {
                          ...
                          return (
                            <DropdownMenuSub
                              ...
                              onOpenChange={(open) => {
                                if (open) {
                                  setOpenSubMenu((prev) => (prev === fieldKey ? prev : fieldKey));
                                } else {
                            ...
                            >
                              <DropdownMenuSubTrigger
                                ...
                                data-highlighted={isHighlighted || undefined}
                                onMouseEnter={() => setHighlightedIndex(index)}
                                className="data-[state=open]:bg-accent data-[state=open]:text-accent-foreground data-highlighted:bg-accent data-highlighted:text-accent-foreground [&>svg:last-child]:hidden"
                              >
