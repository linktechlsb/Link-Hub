...
const files = [
  {
    ...
    icon: <FileTextIcon className="text-muted-foreground size-4 shrink-0" aria-hidden="true" />,
    size: "2.4 MB",
    owner: "Sarah Chen",
    ownerAvatar:
  ...
  },
  {
    ...
    icon: <FolderIcon className="text-muted-foreground size-4 shrink-0" aria-hidden="true" />,
    size: "—",
    owner: "Emily Park",
    ownerAvatar:
  ...
  },
  {
    ...
    icon: (
      <FileSpreadsheetIcon className="text-muted-foreground size-4 shrink-0" aria-hidden="true" />
    ),
    size: "856 KB",
  ...
  },
  {
    ...
    icon: <ImageIcon className="text-muted-foreground size-4 shrink-0" aria-hidden="true" />,
    size: "48.2 MB",
    owner: "David Kim",
    ownerAvatar:
  ...
  },
  {
    ...
    icon: <PenToolIcon className="text-muted-foreground size-4 shrink-0" aria-hidden="true" />,
    size: "12.8 MB",
    owner: "Sofia Davis",
    ownerAvatar:
