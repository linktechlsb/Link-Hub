...
export function ProcessoDetalhePage() {
  ...
  const processoComLiga = processo as ProcessoSeletivoComPerguntas & { liga_nome?: string };
      ...
      <div className="mb-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            {processoComLiga.liga_nome && (
              <p className="text-[12px] text-navy/50">{processoComLiga.liga_nome}</p>
            )}
          </div>
