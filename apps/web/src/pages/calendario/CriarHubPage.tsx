...
export function CriarHubPage() {
  ...
  if (sucesso) {
    return (
      <div className="mx-auto max-w-2xl px-8 py-10">
        <div className="mb-8">
          <h1 className="font-display text-2xl font-bold text-foreground">Hub criado!</h1>
          <p className="mt-1 text-sm text-foreground/50">O hub foi adicionado ao calendário.</p>
        </div>
        <button
  ...
  return (
    <div className="mx-auto max-w-2xl px-8 py-10">
      <div className="mb-8">
        <h1 className="font-display text-2xl font-bold text-foreground">Criar Hub</h1>
        <p className="mt-1 text-sm text-foreground/50">Agende um novo hub para a sua liga</p>
      </div>
